...
module ts {
    ...
    export interface LanguageService {
        ...
        getTypeInfoResolver(): TypeChecker;
    }
    ...
    export class ScriptElementKindModifier {
        ...
        static deprecatedModifier = "deprecated";
    }
    ...
    export function createLanguageService(host: LanguageServiceHost, documentRegistry: DocumentRegistry): LanguageService {
        ...
        function getDefinitionAtPosition(filename: string, position: number): DefinitionInfo[] {
            ...
            if (node.parent.kind === SyntaxKind.ShorthandPropertyAssignment) {
                ...
                forEach(shorthandDeclarations, declaration => {
                    ...
                    result.push(getDefinitionInfo(declaration, getNodeKind(declaration), shorthandSymbolName, shorthandContainerName));
                });
                return result
            }
            ...
            if (!tryAddConstructSignature(symbol, node, symbolKind, symbolName, containerName, result) &&
                ...
                forEach(declarations, declaration => {
                    ...
                    result.push(getDefinitionInfo(declaration, getNodeKind(declaration), symbolName, containerName));
                });
            }
        ...
        return {
            ...
            getRealSourceFile: function(fileName) {
                synchronizeHostData();
                return getSourceFile(normalizeSlashes(fileName));
            },
            getTypeInfoResolver: function() { return typeInfoResolver; }
        };
    }
